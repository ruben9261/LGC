...
<html> 
  <head> 
    <title>Selecci&oacute;n de Cliente</title> 
    	...
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		    ...
		    <form   id="frmSeleccionCliente"  action="<?php echo base_url()?>mantOrdenEntrada_c/procesar_cliente" method="POST"> 
		    	  ...
		    	  <div class="form_group">
		    	        ...
		    	        <a  href="<?php echo base_url()?>mantOrdenEntrada_c/mostrar_Nuevo" class="navbar-text pull-right">
...
function fn_procesar(op,codcliente,nombre,documento) 
{
/* alert('op'+op);
                         ...
                         {   var fila=lista[i];
                              ...
                              sb=sb+"   <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
         	  	              ...
         	  	              sb=sb+"  <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
       	  	         	      ...
       	  	         	      sb=sb+"  </div>";
       	  	      	 	  	  sb=sb+"  <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
       	  	      	 	      sb=sb+"   <a href='#' onclick=fn_procesar("+2+","+fila["COD_CLI"].toString()+",'"+fila["NOMBRE"].toString()+"','"+fila["NRO_DOCUMENTO"].toString()+"') >";
                         ...
                         {  var fila=lista[i];
                              ...
                              sb=sb+"   <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
         	  	              ...
         	  	              sb=sb+"  <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
       	  	         	      ...
       	  	         	      sb=sb+"  </div>";
       	  	      	 	  	  sb=sb+"  <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
       	  	      	          sb=sb+"       <a href='<?php echo base_url('mantOrdenEntrada_c/mostrar_Nuevo_y_cliente')?>"+"?codcliente="+fila['COD_CLI'].toString()+"&nombre="+fila['NOMBRE'].toString()+"&documento="+fila['NRO_DOCUMENTO'].toString()+"'>";
        	  			      sb=sb+"	        Seleccionar&nbsp";
     	  					  sb=sb+"	        <img src='<?php echo base_url()?>public/images/SELECT3.png'>";
     	  					  sb=sb+"	    </a>"; 
     	  					  sb=sb+"  </div>";
                         ...
                         {  var fila=lista[i];
                              ...
                              sb=sb+"   <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
         	  	              ...
         	  	              sb=sb+"  <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
       	  	         	      ...
       	  	         	      sb=sb+"  </div>";
       	  	      	 	  	  sb=sb+"  <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
  	                          sb=sb+"	    <a href='<?php echo base_url('mantOrdenEntrada_c/mostrar_Nuevo_y_cliente')?>"+"/"+fila['COD_CLI'].toString()+"/"+fila["NOMBRE"].toString()+"/"+fila["NRO_DOCUMENTO"].toString()+"'>";
     	  			    	  sb=sb+"	        Seleccionar&nbsp";
     	  					  sb=sb+"	        <img src='<?php echo base_url()?>public/images/SELECT3.png'>";
     	  					  sb=sb+"	    </a>"; 
	   	  			 	      sb=sb+"  </div>";
