...
<html> 
  <head> 
    <title>Consulta de Impuesto</title> 
...
<body> 
    ...
    <div class="container">
         <br/>   
         <P class="text-center" style="color:rgb(0,128,255);">CONSULTA IMPUESTO</P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmConsImpuesto"> 
					   ...
					   sb=sb+" 	  </div>";
                          ...
                          {  var fila=lista[i];
                              ...
                              sb=sb+"   <div class='col-xs-6'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'> ";
   	                          ...
   	                          sb=sb+"	<a href='<?php echo base_url('consImpuesto_c/mostrar_ver')?>"+"/"+fila['COD_IMPUESTO'].toString()+"'>";
      	  			    	  sb=sb+"	   Ver&nbsp";
