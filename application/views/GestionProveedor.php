...
<html> 
  <head> 
    <title>Gesti&oacute;n de Proveedor</title> 
...
<body> 
    ...
    <div class="container">
         ...
         <P class="text-center" style="color:rgb(0,128,255);"> 
		        GESTI&Oacute;N PROVEEDOR
		 </P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmGestProveedor"  action="<?php echo base_url()?>mantProveedor_c/mostrar_Nuevo" method="POST" > 
		    	  ...
		    	  <div class="form_group">
							...
							<input type="text" name="btnbuscar" id="txt_tlfn1"     class="form-control"  placeholder="Primer Telefono">
							<input type="text" name="btnbuscar" id="txt_tlfn2"     class="form-control"  placeholder="Segundo Telefono">
							<br/>
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantProveedor_c/eliminar",
	    	type: 'post',//metodo
	    	data: { codprov:  cod
	    		  }, //parametros
...
function bus_proveedor()
{     
	var Nombre= $("#txt_nombre").val();
    var Documento= $("#txt_documento").val();
    var Tlfn1= $("#txt_tlfn1").val();
    var Tlfn2= $("#txt_tlfn2").val();
	$.ajax({
  		type: "POST",
  		data:{ nombre:Nombre,
               documento:Documento,
                          ...
                          {  var fila=lista[i];
                             ...
                             sb=sb+"   <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
          	  			      ...
          	  			      sb=sb+"   <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
      	  			 	      ...
      	  			 	      sb=sb+"  </div>";
      	  				      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
   	                          sb=sb+"	<a href='<?php echo base_url('mantProveedor_c/mostrar_Editar')?>"+"/"+fila['COD_PROV'].toString()+"'>";
      	  			    	  sb=sb+"	   Editar&nbsp";
      	  					  sb=sb+"	   <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
      	  					  sb=sb+"	</a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_PROV"].toString()+"')>";
	   	  			    	  sb=sb+"	       Eliminar&nbsp";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               <a  class="close" data-dismiss="modal"  onclick="bus_proveedor();">&times;</a>
