...
<html> 
  <head> 
    <title>Gesti&oacute;n de Configuraci&oacute;n de Caja</title> 
...
<body> 
    ...
    <div class="container">
         ...
         <P class="text-center" style="color:rgb(0,128,255);"> 
		        GESTI&Oacute;N CONFIGURACI&Oacute;N DE CAJAS
		 </P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmGestConfigAcceso"  action="<?php echo base_url()?>mantConfigCaja_c/mostrar_Nuevo" method="POST" > 
		    	  ...
		    	  <br/>
		    	  <div class="form_group">
				    	    <input type="text" name="btnbuscar" id="txt_nombusu"  placeholder="Usuario"> 
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantConfigCaja_c/eliminar",
	    	type: 'post',//metodo
	    	data: { codigo:  cod
	    		  }, //parametros
...
$(function(){
$("#txt_nombusu").keypress(function(e) {
   if(e.which == 13) {
...
function bus_config_usu()
{   var nomb_usu = $("#txt_nombusu").val();
	$.ajax({
  		type: "POST",
  		data:{ nomb_usuario:nomb_usu,
  			   pagina:-1
			 },
  		async: true,
  		url: "<?php echo base_url()?>consConfigCaja_c/obt_confcaja_usu", 
               ...
               // alert('tpaginas'+tpaginas);
    			 ...
    			 if(lista.length > 0) 
           	  	 {  
   					   ...
   					   sb=sb+"      USUARIO";  
   					   sb=sb+" 	  </div>"; 
   					   sb=sb+" 	  <div class='col-xs-7' style='background-color:rgb(0,128,255); color:white; font-size:11px;'>";
   					   sb=sb+" 	   Caja ";
   					   sb=sb+" 	  </div>";
                          ...
                          {  var fila=lista[i];
                             ...
                             sb=sb+"   <div class='col-xs-2' style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'> ";
          	  	          	  sb=sb+fila["USUARIO"].toString();
          	  	         	  sb=sb+"  </div>";
          	  	      	 	  sb=sb+"  <div class='col-xs-6' style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'>";
          	  	    	 	  sb=sb+fila["CAJA"].toString();
          	  	    	      sb=sb+"   </div>";
          	  			 	  sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'>";
   	                          sb=sb+"	<a href='<?php echo base_url('mantConfigCaja_c/mostrar_Editar')?>"+"/"+fila['COD_CONFIG_CAJA'].toString()+"'>";
      	  			    	  sb=sb+"	   Editar&nbsp";
      	  					  sb=sb+"	   <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
      	  					  sb=sb+"	</a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-2' style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_CONFIG_CAJA"].toString()+"')>";
	   	  			    	  sb=sb+"	       Eliminar&nbsp";
               ...
               $("#tpagina").val(tpaginas);
                ...
                if(lista.length > 0) 
          	  	 {  
             	  	   var sb="";
  					   sb=sb+" <div class='row'>";
  					   sb=sb+"   <div class='col-xs-3'  style='background-color:rgb(0,128,255); color:white'>";
  					   sb=sb+"      USUARIO";  
  					   sb=sb+" 	  </div>"; 
  					   sb=sb+" 	  <div class='col-xs-7'  style='background-color:rgb(0,128,255); color:white'>";
  					   sb=sb+" 	   Caja ";
  					   sb=sb+" 	  </div>";
  					   sb=sb+"    <div class='col-xs-2'  style='background-color:rgb(0,128,255); color:white'>";
  					   sb=sb+" 		    OPERACI&Oacute;N";
  					   sb=sb+" 	  </div>";				   
  					   sb=sb+"  </div>";
                         ...
                         {  var fila=lista[i];
                            sb=sb+"<div class='row'>";   
                            sb=sb+"   <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255);'> ";
         	  	          	  sb=sb+fila["USUARIO"].toString();
         	  	         	  sb=sb+"  </div>";
         	  	      	 	  sb=sb+"  <div class='col-xs-6' style='background-color:#fff; border: 1px solid rgb(0,128,255);'>";
         	  	    	 	  sb=sb+fila["CAJA"].toString();
         	  	    	      sb=sb+"   </div>";
         	  			 	  sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255);'>";
  	                          sb=sb+"	<a href='<?php echo base_url('mantConfigCaja_c/mostrar_Editar')?>"+"/"+fila['COD_CONFIG_CAJA'].toString()+"'>";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               <a  class="close" data-dismiss="modal"  onclick="bus_config_usu();">&times;</a>
               <h4 class="modal-title" >Eliminaci&oacute;n de configuraci&oacute;n de Cajas</h4>
           </div>
           <div class="modal-body">
        ...
        <div class="modal-content">
           ...
           <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3>Registro de configuraci&oacute;n de Cajas</h3>
           </div>
           <div class="modal-body">
