...
<body> 
    ...
    <div class="container">
         ...
         <P class="text-center" style="color:rgb(0,128,255);"> 
		        GESTI&Oacute;N USUARIO
		 </P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmGestUsuario"  action="<?php echo base_url()?>mantUsuario_c/mostrar_Nuevo" method="POST" > 
		    	  ...
		    	  <br/>
		    	  <div class="form_group">
				    	    <input type="text" name="btnbuscar" id="txt_nombre"    class="form-control"  placeholder="Nombre"> 
							<input type="text" name="btnbuscar" id="txt_apellido" class="form-control"  placeholder="Documento">
							<input type="text" name="btnbuscar" id="txt_cargo"     class="form-control"  placeholder="Cargo">
							<br/>
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantUsuario_c/eliminar",
	    	type: 'post',//metodo
	    	data: { codusu:  cod
	    		  }, //parametros
...
{     
	...
	$.ajax({
  		...
  		async: true,
  		url: "<?php echo base_url()?>consUsuario_c/obt_datos", 
               ...
               // alert('tpaginas'+tpaginas);
    			 ...
    			 if(lista.length > 0) 
           	  	 {  
              	  	   var sb="";
   					   sb=sb+" <div class='row'>";
   					   sb=sb+"   <div class='col-xs-3'  style='background-color:rgb(0,128,255); color:white; font-size:12px;'>";
   					   sb=sb+"      NOMBRES";  
   					   sb=sb+" 	  </div>"; 
   					   sb=sb+" 	  <div class='col-xs-3'  style='background-color:rgb(0,128,255); color:white; font-size:12px;'>";
   					   sb=sb+" 	   APELLIDOS ";
                          ...
                          {  var fila=lista[i];
                             sb=sb+"<div class='row'>";   
                             sb=sb+"   <div class='col-xs-3'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
          	  	          	  sb=sb+fila["NOM_USU"].toString();
          	  	         	  sb=sb+"  </div>";
          	  	      	 	  sb=sb+"  <div class='col-xs-3' style='background-color:#fff; border: 1px solid rgb(0,128,255);font-size:11px;'>";
          	  	    	 	  sb=sb+fila["APE_USU"].toString();
          	  	    	      sb=sb+"   </div>";
          	  			 	  sb=sb+"   <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
          	  			  	  sb=sb+fila["CARGO"].toString();
          	  			 	  sb=sb+"  </div>";
          	  			      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
   	                          sb=sb+"	    <a href='<?php echo base_url('mantUsuario_c/mostrar_Editar')?>"+"/"+fila['COD_USU'].toString()+"'>";
      	  			    	  sb=sb+"	            Editar&nbsp";
      	  					  sb=sb+"	            <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
      	  					  sb=sb+"	     </a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_USU"].toString()+"')>";
	   	  			    	  sb=sb+"	            Eliminar&nbsp";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               <a  class="close" data-dismiss="modal"  onclick="bus_Usuario();">&times;</a>
