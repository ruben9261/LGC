...
<html> 
  <head> 
    <title>Gesti&oacute;n de Caja</title> 
...
<body> 
    ...
    <div class="container">
    	...
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		    ...
		    <form   id="frmGestCaja" action="<?php echo base_url()?>mantCaja_c/mostrar_Nuevo" method="POST"> 
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantCaja_c/eliminar",
	    	type: 'post',//metodo
	    	data: { codcaja:  cod
	    		  }, //parametros
                          ...
                          {  var fila=lista[i];
                              ...
                              sb=sb+"   <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
          	  	    	      ...
          	  	    	      sb=sb+"   </div>";
          	  			 	  ...
          	  			 	  sb=sb+"  </div>";
          	  			      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
   	                          sb=sb+"	<a href='<?php echo base_url('mantCaja_c/mostrar_Editar')?>"+"/"+fila['COD_CAJA'].toString()+"'>";
      	  			    	  sb=sb+"	   Editar&nbsp";
      	  					  sb=sb+"	   <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
      	  					  sb=sb+"	</a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_CAJA"].toString()+"')>";
	   	  			    	  sb=sb+"	       Eliminar&nbsp";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               <a  class="close" data-dismiss="modal"  onclick="bus_Caja();">&times;</a>
               <h4 class="modal-title" >Eliminaci&oacute;n de Caja</h4>
           </div>
           <div class="modal-body">
