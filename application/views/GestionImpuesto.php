...
<html> 
  <head> 
    <title>Gesti&oacute;n de Impuesto</title> 
...
<body> 
    ...
    <div class="container">
         ...
         <P class="text-center" style="color:rgb(0,128,255);"> 
		        GESTI&Oacute;N IMPUESTO
		 </P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmGestImpuesto"  action="<?php echo base_url()?>mantImpuesto_c/mostrar_Nuevo" method="POST" > 
		    	  ...
		    	  <br/>
		    	  <div class="form_group">
				    	    <input type="text"  id="txt_nombre" class="form-control"  placeholder="Nombre Impuesto"> 
							<input type="text"  id="txt_abrev"  class="form-control"  placeholder="Abreviatura">
							<br/>
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantImpuesto_c/eliminar",
	    	type: 'post',//metodo
	    	data: { codigo:  cod
	    		  }, //parametros
...
function bus_impuesto()
{	var v_nombre= $("#txt_nombre").val();
    var v_abrev= $("#txt_abrev").val();
	$.ajax({
  		type: "POST",
  		...
  		async: true,
  		url: "<?php echo base_url()?>consImpuesto_c/obt_datos", 
					   ...
					   sb=sb+" 	  </div>";
                          ...
                          {  var fila=lista[i];
                              ...
                              sb=sb+"   <div class='col-xs-6'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'> ";
          	  	          	  sb=sb+fila["NOMB_IMPUESTO"].toString();
          	  	         	  sb=sb+"  </div>";
          	  	         	  sb=sb+"   <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'> ";
        	  	          	  sb=sb+fila["ABREVIATURA"].toString();
        	  	         	  sb=sb+"  </div>";
        	  	      	 	  sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'>";
   	                          sb=sb+"	<a href='<?php echo base_url('mantImpuesto_c/mostrar_Editar')?>"+"/"+fila['COD_IMPUESTO'].toString()+"'>";
      	  			    	  sb=sb+"	   Editar&nbsp";
      	  					  sb=sb+"	   <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
      	  					  sb=sb+"	</a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_IMPUESTO"].toString()+"')>";
	   	  			    	  sb=sb+"	       Eliminar&nbsp";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               <a  class="close" data-dismiss="modal"  onclick="bus_impuesto();">&times;</a>
               <h4 class="modal-title" >Eliminaci&oacute;n de Impuesto</h4>
           </div>
           <div class="modal-body">
