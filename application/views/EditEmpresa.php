...
<body>
	...
	<div class="container" id="contenedor" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);  width: 45%; height:50%;">
		           <br/>
				    ...
				    <form id="frmEditEmpresa">
					        <div class="form-group">
						          <input id="nombre" type="text" class="form-control" placeholder="Nombre" value="<?php echo $nombre?>" >
						    </div>
						   
						    <div class="form-group">
						         <input id="domicilio" type="text" class="form-control" placeholder="Domicilio Fiscal" value="<?php echo $domicilio?>">
						    </div>
						  
						    <div class="form-group">
						         <input id="ruc" type="text" class="form-control" placeholder="Ruc" value="<?php echo $ruc?>">
						    </div>
						    
						    <div class="form-group">
						         <input id="tlfn"   type="text" class="form-control" placeholder="Telefono" value="<?php echo $tlfn?>">
						    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               <h3>Edici&oacute;n de Empresa</h3>
           </div>
...
$.ajax({
	    url:  "<?php echo base_url()?>mantEmpresa_c/editar",
	    type: 'post',//metodo
	    data: { cod_emp:cod,
		        nombre:  nomb,
		        domicilio:domi,
