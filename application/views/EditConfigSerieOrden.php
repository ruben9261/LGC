...
<html> 
  <head> 
    <title>Editar Configuraci&oacute;n de Serie Orden </title> 
...
<body>
	...
	<div class="container" id="contenedor" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);  width: 60%; height:50%;">
		            ...
		            <div class="modal-header" style="color:rgb(0,128,255);"> 
		                 <STRONG>Editar Configuraci&oacute;n de Serie Orden</STRONG>
		            </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               <h3>Edici&oacute;n de configuraci&oacute;n de Serie Orden</h3>
           </div>
...
{  var cod=<?php echo $cod_conf?>; 
   ...
   $.ajax({
	    url:  "<?php echo base_url()?>mantConfigSerieOrden_c/editar",
	    type: 'post',//metodo
	    data: { codigo:cod,
		        usuario: v_usu,
		        serie:   v_serie 
