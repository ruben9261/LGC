...
<body>
	...
	<div class="container" id="contenedor" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);  width: 45%; height:50%;">
		           <br/>
				    ...
				    <form id="frmEditProveedor">
					        <div class="form-group">
						          <input id="nombre" type="text" class="form-control" placeholder="Nombre" value="<?php echo $nombre?>">
						    </div>
						   
						    <div class="form-group">
						         <input id="documento" type="text" class="form-control" placeholder="Documento" value="<?php echo $documento?>">
						    </div>
						    ...
						    <div class="form-group">
						       <select  id="oferta" name="oferta"  class="form-control">
							    ...
							    <script type="text/javascript">
										         $("#oferta option[value="+"<?php echo $codoferta?>" +"]").attr("selected",true); 
								</script>     
						   ...
						   <div class="form-group">
						    ...
						    <div class="form-group">
						        <input id="correo1" type="text" class="form-control" placeholder="Primer Correo" value="<?php echo $correo1?>">
						    </div>
						    
						    <div class="form-group">
						         <input  id="correo2"  type="text" class="form-control" placeholder="Segundo Correo" value="<?php echo $correo2?>">
						    </div>
						    
						    <div class="form-group">
						        <textarea id="comentario" rows="10" cols="80" class="form-control" placeholder="Comentario" ><?php echo $comentario?></textarea>
						    </div>
