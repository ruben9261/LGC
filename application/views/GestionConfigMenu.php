...
<html> 
  <head> 
    <title>Gesti&oacute;n de Configuraci&oacute;n de Menu</title> 
...
<body> 
    ...
    <div class="container">
         ...
         <P class="text-center" style="color:rgb(0,128,255);"> 
		        GESTI&Oacute;N CONFIGURACI&Oacute;N DE MEN&Uacute;
		 </P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmGestConfigAcceso"  action="<?php echo base_url()?>mantConfigMenu_c/mostrar_Nuevo" method="POST" > 
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantConfigMenu_c/eliminar",
	    	type: 'post',//metodo
	    	data: { codperfil:  cod
	    		  }, //parametros
...
{   var nomb_usu = $("#txt_nombusu").val();
	$.ajax({
  		...
  		async: true,
  		url: "<?php echo base_url()?>consConfigMenu_c/obt_conf_usu", 
           	  	 ...
           	  	 {  
                          ...
                          {  var fila=lista[i];
                             ...
                             sb=sb+"   <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255);'> ";
          	  	          	  sb=sb+fila["NOMBCOMPLETO"].toString();
          	  	         	  sb=sb+"  </div>";
          	  	      	 	  sb=sb+"  <div class='col-xs-3' style='background-color:#fff; border: 1px solid rgb(0,128,255);'>";
          	  	    	 	  sb=sb+fila["NOMBMENU"].toString();
          	  	    	      sb=sb+"   </div>";
          	  			 	  sb=sb+"   <div class='col-xs-3'  style='background-color:#fff; border: 1px solid rgb(0,128,255);'>";
          	  			  	  sb=sb+fila["NOMBITEM"].toString();
          	  			 	  sb=sb+"  </div>";
      	  				      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255);'>";
   	                          sb=sb+"	<a href='<?php echo base_url('mantConfigMenu_c/mostrar_Editar')?>"+"/"+fila['COD_PERFIL'].toString()+"'>";
      	  			    	  sb=sb+"	   Editar&nbsp";
      	  					  sb=sb+"	   <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
      	  					  sb=sb+"	</a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255);'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_PERFIL"].toString()+"')>";
	   	  			    	  sb=sb+"	       Eliminar&nbsp";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               ...
               <h4 class="modal-title" >Eliminaci&oacute;n de configuraci&oacute;n de Menus</h4>
           </div>
           <div class="modal-body">
