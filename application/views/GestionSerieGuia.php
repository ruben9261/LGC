...
<html> 
  <head> 
    <title>Gesti&oacute;n de Serie Guia</title> 
...
<body> 
    ...
    <div class="container">
         ...
         <P class="text-center" style="color:rgb(0,128,255);"> 
		        GESTI&Oacute;N SERIE GUIA
		 </P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmGestSerie"  action="<?php echo base_url()?>mantSerieGuia_c/mostrar_Nuevo" method="POST" > 
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantSerieGuia_c/eliminar",
	    	type: 'post',//metodo
	    	data: { codserie:  cod
	    		  }, //parametros
...
{     
    ...
    $.ajax({
  		...
  		async: true,
  		url: "<?php echo base_url()?>consSerieGuia_c/obt_datos", 
 					   ...
 					   sb=sb+" 	  </div>"; 
                          ...
                          {  var fila=lista[i];
                              ...
                              sb=sb+"   <div class='col-xs-6'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
   	                          ...
   	                          sb=sb+"	<a href='<?php echo base_url('mantSerieGuia_c/mostrar_Editar')?>"+"/"+fila['COD_SER_GUIA'].toString()+"'>";
      	  			    	  sb=sb+"	   Editar&nbsp";
      	  					  sb=sb+"	   <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
      	  					  sb=sb+"	</a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-1'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_SER_GUIA"].toString()+"')>";
	   	  			    	  sb=sb+"	       Eliminar&nbsp";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               ...
               <h4 class="modal-title" >Eliminaci&oacute;n de Serie de Guia</h4>
           </div>
           <div class="modal-body">
