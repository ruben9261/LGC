...
<html> 
  <head> 
    <title>Gesti&oacute;n de Serie Orden</title> 
...
<body> 
    ...
    <div class="container">
         ...
         <P class="text-center" style="color:rgb(0,128,255);"> 
		        GESTI&Oacute;N SERIE ORDEN
		 </P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmGestSerie"  action="<?php echo base_url()?>mantSerieOrden_c/mostrar_Nuevo" method="POST" > 
		    	  ...
		    	  <br/>
		    	  <div class="form_group">
				    	    <input type="text" name="btnbuscar" id="txt_oficina"    class="form-control"  placeholder="Oficina"> 
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantSerieOrden_c/eliminar",
	    	type: 'post',//metodo
	    	data: { codserie:  cod
	    		  }, //parametros
...
$(function(){
$("#txt_oficina").keypress(function(e) {
   if(e.which == 13) {
...
{     
    ...
    $.ajax({
  		...
  		async: true,
  		url: "<?php echo base_url()?>consSerieOrden_c/obt_datos", 
    			 ...
    			 if(lista.length > 0) 
           	  	 {  
 					   ...
 					   sb=sb+" 	  </div>";
                          ...
                          {  var fila=lista[i];
                             sb=sb+"<div class='row'>";   
                             sb=sb+"   <div class='col-xs-6'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
   	                          ...
   	                          sb=sb+"	<a href='<?php echo base_url('mantSerieOrden_c/mostrar_Editar')?>"+"/"+fila['COD_SER_ORDEN'].toString()+"'>";
      	  			    	  sb=sb+"	   Editar&nbsp";
      	  					  sb=sb+"	   <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
      	  					  sb=sb+"	</a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-1'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_SER_ORDEN"].toString()+"')>";
	   	  			    	  sb=sb+"	       Eliminar&nbsp";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               ...
               <h4 class="modal-title" >Eliminaci&oacute;n de Serie de Orden</h4>
           </div>
           <div class="modal-body">
        ...
        <div class="modal-content">
           ...
           <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3>Registro de Serie de Orden</h3>
           </div>
           <div class="modal-body">
