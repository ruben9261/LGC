...
<html> 
  <head> 
    <title>Configuraci&oacute;n Serie Orden</title> 
...
<body> 
    ...
    <div class="container">
         ...
         <P class="text-center" style="color:rgb(0,128,255);"> 
		      CONFIGURACI&Oacute;N SERIE ORDEN
		 </P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmGestConfigSerieOrden"  action="<?php echo base_url()?>mantConfigSerieOrden_c/mostrar_Nuevo" method="POST" > 
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantConfigSerieOrden_c/eliminar",
	    	type: 'post',//metodo
	    	data: { codigo:  cod
	    		  }, //parametros
...
{   var nomb_usu = $("#txt_nombusu").val();
	$.ajax({
  		...
  		async: true,
  		url: "<?php echo base_url()?>consConfigSerieOrden_c/obt_confSerieOrden_usu", 
          	  	 ...
          	  	 {  
                         ...
                         {  var fila=lista[i];
                            ...
                            sb=sb+"   <div class='col-xs-2' style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'> ";
         	  	    	 	  ...
         	  	    	 	  sb=sb+fila["SERIE_ORDEN"].toString();
         	  	    	      sb=sb+"   </div>";
         	  			 	  sb=sb+"  <div class='col-xs-1'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'>";
  	                          sb=sb+"	<a href='<?php echo base_url('mantConfigSerieOrden_c/mostrar_Editar')?>"+"/"+fila['COD_CONF_SER_ORDEN'].toString()+"'>";
     	  			    	  sb=sb+"	   Editar&nbsp";
     	  					  sb=sb+"	   <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
     	  					  sb=sb+"	</a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-1' style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_CONF_SER_ORDEN"].toString()+"')>";
	   	  			    	  sb=sb+"	       Eliminar";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               ...
               <h4 class="modal-title" >Eliminaci&oacute;n de configuraci&oacute;n serie de Orden</h4>
           </div>
           <div class="modal-body">
        ...
        <div class="modal-content">
           ...
           <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3>Registro de configuraci&oacute;n de serie de Orden</h3>
           </div>
           <div class="modal-body">
