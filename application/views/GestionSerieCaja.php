...
<html> 
  <head> 
    <title>Gesti&oacute;n de Serie Caja</title> 
...
<body> 
    ...
    <div class="container">
         ...
         <P class="text-center" style="color:rgb(0,128,255);"> 
		        GESTI&Oacute;N SERIE CAJA
		 </P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmGestSerie"  action="<?php echo base_url()?>mantSerieCaja_c/mostrar_Nuevo" method="POST" > 
		    	  ...
		    	  <br/>
		    	  <div class="form_group">
				    	    <input type="text" name="btnbuscar" id="txt_caja"    class="form-control"  placeholder="Caja"> 
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantSerieCaja_c/eliminar",
	    	type: 'post',//metodo
	    	data: { codserie:  cod
	    		  }, //parametros
...
{     
    ...
    $.ajax({
  		...
  		async: true,
  		url: "<?php echo base_url()?>consSerieCaja_c/obt_datos", 
               ...
               // alert('tpaginas'+tpaginas);
    			 ...
    			 if(lista.length > 0) 
           	  	 {  
              	  	   var sb="";
   					   sb=sb+" <div class='row'>";
   					   sb=sb+"   <div class='col-xs-5'  style='background-color:rgb(0,128,255); color:white; font-size:12px;'>";
   					   sb=sb+"     DESCRIPCI&Oacute;N DE CAJA ";  
   					   sb=sb+" 	  </div>"; 
   					   sb=sb+" 	  <div class='col-xs-6'  style='background-color:rgb(0,128,255); color:white; font-size:12px;'>";
   					   sb=sb+" 	    SERIE";
   					   sb=sb+" 	  </div>";
                          ...
                          {  var fila=lista[i];
                             sb=sb+"<div class='row'>";   
                             sb=sb+"   <div class='col-xs-5'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
          	  	          	  sb=sb+fila["NOMB_CAJA"].toString();
          	  	         	  sb=sb+"  </div>";
          	  	      	 	  sb=sb+"  <div class='col-xs-5' style='background-color:#fff; border: 1px solid rgb(0,128,255);font-size:11px;'>";
   	                          ...
   	                          sb=sb+"	<a href='<?php echo base_url('mantSerieCaja_c/mostrar_Editar')?>"+"/"+fila['COD_SERIE'].toString()+"'>";
      	  			    	  sb=sb+"	   Editar&nbsp";
      	  					  sb=sb+"	   <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
      	  					  sb=sb+"	</a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-1'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_SERIE"].toString()+"')>";
	   	  			    	  sb=sb+"	       Eliminar&nbsp";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               <a  class="close" data-dismiss="modal"  onclick="bus_Serie();">&times;</a>
               <h4 class="modal-title" >Eliminaci&oacute;n de Serie</h4>
           </div>
           <div class="modal-body">
