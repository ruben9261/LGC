...
<body> 
    ...
    <div class="container">
         <br/>   
         <P class="text-center" style="color:rgb(0,128,255);">CONSULTA CLIENTE</P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmConsCliente"> 
                         ...
                         {  var fila=lista[i];
                              ...
                              sb=sb+"   <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'> ";
         	  	              ...
         	  	              sb=sb+"   <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'> ";
       	  	         	      ...
       	  	         	      sb=sb+"  </div>";
       	  	      	 	  	  sb=sb+"  <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'>";
  	                          sb=sb+"	<a href='<?php echo base_url('consCliente_c/mostrar_ver')?>"+"/"+fila['COD_CLI'].toString()+"'>";
     	  			    	  sb=sb+"	   Ver&nbsp";
