...
<html> 
  <head> 
    <title>Editar Configuraci&oacute;n de Serie Guia </title> 
...
<body>
	...
	<div class="container" id="contenedor" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);  width: 60%; height:50%;">
		            ...
		            <div class="modal-header" style="color:rgb(0,128,255);"> 
		                 <STRONG>Editar Configuraci&oacute;n de Serie Guia</STRONG>
		            </div>
				   <form  id="frmCreaConfigSerieGuia"  action="<?php echo base_url()?>mantConfigSerieGuia_c/insertar" method="POST"> 
							  ...
							  <div class="form-group">
								     <select class="form-control" id="serie" name="serie">
								       ...
								       <script type="text/javascript">
							         		 $("#serie option[value="+"<?php echo $codserie?>" +"]").attr("selected",true);
										</script> 
							  </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               <h3>Edici&oacute;n de configuraci&oacute;n de SerieGuia</h3>
           </div>
        ...
        <div class="modal-content">
           ...
           <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3>Edici&oacute;n  de configuraci&oacute;n de Serie Guia</h3>
           </div>
           <div class="modal-body">
...
function editar()
{  var cod=<?php echo $cod_conf?>; 
   var v_usu= $("#usuario").val();
   var v_serie= $("#serie").val();

   $.ajax({
	    url:  "<?php echo base_url()?>mantConfigSerieGuia_c/editar",
	    type: 'post',//metodo
	    data: { codigo:cod,
		        usuario: v_usu,
		        serie:   v_serie 
