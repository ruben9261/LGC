...
<html> 
  <head> 
    <title>Gesti&oacute;n de EMPRESA</title> 
...
<body> 
    ...
    <div class="container">
         ...
         <P class="text-center" style="color:rgb(0,128,255);"> 
		        GESTI&Oacute;N EMPRESA
		 </P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmGestEmpresa"  action="<?php echo base_url()?>mantEmpresa_c/mostrar_Nuevo" method="POST" > 
		    	  ...
		    	  <br/>
		    	  <div class="form_group">
				    	    <input type="text" name="btnbuscar" id="txt_nombre"    class="form-control"  placeholder="Nombre de Empresa"> 
							<input type="text" name="btnbuscar" id="txt_ruc"      class="form-control"  placeholder="RUC">
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantEmpresa_c/eliminar",
	    	type: 'post',//metodo
	    	data: { codemp:  cod
	    		  }, //parametros
...
{     
    ...
    var Tlfn= $("#txt_tlfn").val();
   	$.ajax({
  		...
  		async: true,
  		url: "<?php echo base_url()?>consEmpresa_c/obt_datos", 
           	  	 ...
           	  	 {  
                          ...
                          {  var fila=lista[i];
                              ...
                              sb=sb+"   <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
          	  	    	 	  ...
          	  	    	 	  sb=sb+fila["RUC"].toString();
          	  	    	      sb=sb+"   </div>";
          	  			 	  sb=sb+"   <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
          	  			  	  sb=sb+fila["TLFN"].toString();
          	  			 	  sb=sb+"  </div>";
          	  			      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
   	                          sb=sb+"	<a href='<?php echo base_url('mantEmpresa_c/mostrar_Editar')?>"+"/"+fila['COD_EMP'].toString()+"'>";
      	  			    	  sb=sb+"	   Editar&nbsp";
      	  					  sb=sb+"	   <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
      	  					  sb=sb+"	</a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_EMP"].toString()+"')>";
	   	  			    	  sb=sb+"	       Eliminar&nbsp";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               <a  class="close" data-dismiss="modal"  onclick="bus_Empresa();">&times;</a>
               <h4 class="modal-title" >Eliminaci&oacute;n de Empresa</h4>
           </div>
           <div class="modal-body">
