...
<html> 
  <head> 
    <title>Gesti&oacute;n de Contacto</title> 
...
<body> 
    ...
    <div class="container">
         ...
         <P class="text-center" style="color:rgb(0,128,255);"> 
		        GESTI&Oacute;N DE CONTACTO
		 </P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmGestContacto"  action="<?php echo base_url()?>mantContacto_c/mostrar_Nuevo" method="POST" > 
		    	  ...
		    	  <div class="form_group">
		    	       ...
		    	       <a  href="<?php echo base_url()?>mantCliente_c/mostrar_Nuevo" class="navbar-text pull-right">
							<img src="<?php echo base_url()?>public/images/CLIENTES.png" class="dropdown">
							Clientes
					   </a>
		    	  ...
		    	  <br/>
		    	  <div class="form_group">
				    	    <input type="text" name="btnbuscar" id="txt_nombre"    class="form-control"  placeholder="Nombre Contacto"> 
							<br/>
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantContacto_c/eliminar",
	    	type: 'post',//metodo
	    	data: { codigo:  cod
	    		  }, //parametros
...
{	var v_nombre= $("#txt_nombre").val();
 	$.ajax({
  		...
  		async: true,
  		url: "<?php echo base_url()?>consContacto_c/obt_datos", 
               ...
               // alert('tpaginas'+tpaginas);
    			 ...
    			 if(lista.length > 0) 
           	  	 {  
   					   ...
   					   sb=sb+"      NOMBRE DE CONTACTO";  
   					   sb=sb+" 	  </div>"; 
   					   sb=sb+"   <div class='col-xs-3'  style='background-color:rgb(0,128,255); color:white; font-size:11px;'>";
 					   sb=sb+"       PRIMER TELEFONO";  
 					   sb=sb+" 	  </div>"; 
 					   sb=sb+"   <div class='col-xs-3'  style='background-color:rgb(0,128,255); color:white; font-size:11px;'>";
  					   sb=sb+"      SEGUNDO TELEFONO";  
  					   sb=sb+" 	  </div>"; 
  					   sb=sb+"    <div class='col-xs-3'  style='background-color:rgb(0,128,255); color:white; font-size:11px;'>";
                          ...
                          {  var fila=lista[i];
                              ...
                              sb=sb+"   <div class='col-xs-3'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'> ";
          	  	          	  sb=sb+fila["NOMB_CONTACTO"].toString();
          	  	         	  sb=sb+"  </div>";
	          	  	          sb=sb+"   <div class='col-xs-3'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'> ";
	      	  	          	  sb=sb+fila["TLFN1"].toString();
	      	  	         	  sb=sb+"  </div>";
		      	  	          sb=sb+"   <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'> ";
		  	  	          	  sb=sb+fila["TLFN2"].toString();
		  	  	         	  sb=sb+"  </div>";
          	  	      	 	  sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'>";
   	                          sb=sb+"	<a href='<?php echo base_url('mantContacto_c/mostrar_Editar')?>"+"/"+fila['COD_CONTACT'].toString()+"'>";
      	  			    	  sb=sb+"	   Editar&nbsp";
      	  					  sb=sb+"	   <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
      	  					  sb=sb+"	</a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_CONTACT"].toString()+"')>";
	   	  			    	  sb=sb+"	       Eliminar&nbsp";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               <a  class="close" data-dismiss="modal"  onclick="bus_Contacto();">&times;</a>
               <h4 class="modal-title" >Eliminaci&oacute;n de Contacto</h4>
           </div>
           <div class="modal-body">
