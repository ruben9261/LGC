	...
	<div class="container" id="contenedor" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);  width: 45%; height:50%;">
		           <br/>
		            <div class="modal-header" style="color:rgb(0,128,255);"> 
		                 <STRONG>Editar Oficina</STRONG>
		            </div>
				    <form id="frmEditOficina">
					        <div class="form-group">
						          <input id="nombre" type="text" class="form-control" placeholder="Nombre" value="<?php echo $nombre?>" >
						    </div>
						   
						    <div class="form-group">
						         <input id="domicilio" type="text" class="form-control" placeholder="Documento" value="<?php echo $domicilio?>">
						    </div>
						    ...
						    <div class="form-group">
						       <select  id="empresa" name="empresa"  class="form-control">
							    ...
							    <script type="text/javascript">
										         $("#empresa option[value="+"<?php echo $cod_emp?>" +"]").attr("selected",true); 
								</script>     
							   
						   </div>
						    
						   <div class="form-group">
						         <input id="tlfn" type="text" class="form-control" placeholder="Tele&acute;fono" value="<?php echo $tlfn?>">
						    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               <h3>Edici&oacute;n de Oficina</h3>
           </div>
...
$.ajax({
	    url:  "<?php echo base_url()?>mantOficina_c/editar",
	    type: 'post',//metodo
	    data: { cod_ofi:cod,
		        nombre: nomb,
		        domicilio:domi,
