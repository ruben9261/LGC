...
<body> 
    ...
    <div class="container">
    	...
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		    ...
		    <form   id="frmGestOrdenEntrada"  action="<?php echo base_url()?>mantOrdenEntrada_c/mostrar_Nuevo" method="POST" > 
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantOrdenEntrada_c/eliminar",
	    	type: 'post',//metodo
...
{     
    ...
    $.ajax({
  		...
  		async: true,
  		url: "<?php echo base_url()?>consOrdenEntrada_c/obt_datos", 
					   ...
					   sb=sb+"   <div class='col-xs-2'  style='background-color:rgb(0,128,255); color:white; font-size:12px;'>";
                          ...
                          {  var fila=lista[i];
                             ...
                             sb=sb+"   <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'> ";
          	  	    	      ...
          	  	    	      sb=sb+"   </div>";
          	  	    	  	  sb=sb+"  <div class='col-xs-2' style='background-color:#fff; border: 1px solid rgb(0,128,255);font-size:11px;'>";
      	  	    	 	  	  sb=sb+fila["CLIENTE"].toString();
      	  	    	          sb=sb+"   </div>";
      	  	    	      	  sb=sb+"  <div class='col-xs-2' style='background-color:#fff; border: 1px solid rgb(0,128,255);font-size:11px;'>";
  	  	    	 	  	  	  sb=sb+fila["DOCUMENTO"].toString();
  	  	    	              sb=sb+"   </div>";
					          sb=sb+"  <div class='col-xs-1'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
   	                          sb=sb+"	<a href='<?php echo base_url('mantOrdenEntrada_c/mostrar_Editar')?>"+"/"+fila['COD_ORDEN_E'].toString()+"'>";
      	  			    	  sb=sb+"	   Editar&nbsp";
      	  					  sb=sb+"	   <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
      	  					  sb=sb+"	</a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-1'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_ORDEN_E"].toString()+"')>";
	   	  			    	  sb=sb+"	       Anular&nbsp";
