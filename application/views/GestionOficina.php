...
<html> 
  <head> 
    <title>Gesti&oacute;n de Oficina</title> 
...
<body> 
    ...
    <div class="container">
         ...
         <P class="text-center" style="color:rgb(0,128,255);"> 
		        GESTI&Oacute;N OFICINA
		 </P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmGestOficina"  action="<?php echo base_url()?>mantOficina_c/mostrar_Nuevo" method="POST" > 
		    	  ...
		    	  <div class="form_group">
							...
							<input type="text" name="btnbuscar" id="txt_domicilio" class="form-control"  placeholder="Domicilio">
							<input type="text" name="btnbuscar" id="txt_tlfn"      class="form-control"  placeholder="Tel&eacute;fono">
...
{  $.ajax({
		    url:  "<?php echo base_url()?>mantOficina_c/eliminar",
	    	type: 'post',//metodo
	    	data: { codofi:  cod
	    		  }, //parametros
...
$(function(){
	$("#txt_domicilio").keypress(function(e) {
	   if(e.which == 13) {
	         // Acciones a realizar, por ej: enviar formulario.
		    bus_Oficina();
		   return false;
...
function bus_Oficina()
{     
	var nomb= $("#txt_nombre").val();
    var dom= $("#txt_domicilio").val();
    var tlf= $("#txt_tlfn").val();
	...
	$.ajax({
  		...
  		async: true,
  		url: "<?php echo base_url()?>consOficina_c/obt_datos", 
           	  	 ...
           	  	 {  
                          ...
                          {  var fila=lista[i];
                              ...
                              sb=sb+"   <div class='col-xs-4'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
          	  	    	 	  ...
          	  	    	 	  sb=sb+fila["DOMICILIO"].toString();
          	  	    	      sb=sb+"   </div>";
          	  			 	  sb=sb+"   <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
          	  			  	  sb=sb+fila["TLFN"].toString();
          	  			 	  sb=sb+"  </div>";
          	  			      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
   	                          sb=sb+"	<a href='<?php echo base_url('mantOficina_c/mostrar_Editar')?>"+"/"+fila['COD_OFI'].toString()+"'>";
      	  			    	  sb=sb+"	   Editar&nbsp";
      	  					  sb=sb+"	   <img src='<?php echo base_url()?>public/images/EDITAR.png'>";
      	  					  sb=sb+"	</a>"; 
	   	  			 	      sb=sb+"  </div>";
	   	  			 	      sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
	   	  			 	      sb=sb+"	    <a href='#' onclick=fn_eliminar('"+fila["COD_OFI"].toString()+"')>";
	   	  			    	  sb=sb+"	       Eliminar&nbsp";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
               <a  class="close" data-dismiss="modal"  onclick="bus_Oficina();">&times;</a>
               <h4 class="modal-title" >Eliminaci&oacute;n de Oficina</h4>
           </div>
           <div class="modal-body">
