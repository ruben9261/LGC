...
<html> 
  <head> 
    <title>Editar Serie Orden</title> 
	...
	<div class="container" id="contenedor" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);  width: 45%; height:50%;">
		           <br/>
		            <div class="modal-header" style="color:rgb(0,128,255);"> 
		                 <STRONG>Editar Serie Orden</STRONG>
		            </div>
				    <form id="frmCreaSerie">
						   ...
						   <script type="text/javascript">
								$("#oficina option[value="+"<?php echo $codofi?>" +"]").attr("selected",true); 
							</script>     
							   
							 <div class="form-group">
						       <select  id="tipo" name="tipo"  class="form-control">
								    <option value="0">
											SELECCIONAR TIPO SERIE
								     </option>
						   ...
						   <div class="form-group">
							   ...
							   <a href="<?php echo base_url()?>ConsSerieOrden_c/" class="btn btn-primary"  id="boton1" style="background-color: white; border: 1px solid rgb(0,128,255); color:rgb(0,128,255);">
							        Cancelar
...
$.ajax({
	    url:  "<?php echo base_url()?>MantSerieOrden_c/editar",
	    type: 'post',//metodo
	    data: { codigo: cod,
		    	oficina: v_oficina,
	    		tipo:   v_tipo,
