...
<body> 
    ...
    <div class="container">
         <br/>   
         <P class="text-center" style="color:rgb(0,128,255);">CONSULTA DE CONTACTO</P>
         <br/>
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		     
		    <form   id="frmConsContacto"> 
                          ...
                          {  var fila=lista[i];
                              ...
                              sb=sb+"   <div class='col-xs-3'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'> ";
		      	  	          ...
		      	  	          sb=sb+"   <div class='col-xs-3'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'> ";
		  	  	         	  ...
		  	  	         	  sb=sb+"  </div>";
          	  	      	 	  sb=sb+"  <div class='col-xs-3'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:10px;'>";
   	                          sb=sb+"	<a href='<?php echo base_url('consContacto_c/mostrar_ver')?>"+"/"+fila['COD_CONTACT'].toString()+"'>";
      	  			    	  sb=sb+"	   Ver&nbsp";
