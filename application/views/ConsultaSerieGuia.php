...
<html> 
  <head> 
    <title>Consulta de Serie Guia</title> 
    	...
    	<div class="well" style="background-color:rgb(255,255,255); border: 1px solid rgb(0,128,255);">    	     
		    ...
		    <form   id="frmConsSerie"> 
		    	  ...
		    	  <div class="form_group">
							...
							<input type="text" name="btnbuscar" id="txt_serie" class="form-control"  placeholder="Serie de guia">
						     <br/>
 					   ...
 					   sb=sb+" 	  </div>";
                          ...
                          {  var fila=lista[i];
                              ...
                              sb=sb+"   <div class='col-xs-6'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'> ";
          	  	    	      ...
          	  	    	      sb=sb+"   </div>";
          	  			 	  sb=sb+"  <div class='col-xs-2'  style='background-color:#fff; border: 1px solid rgb(0,128,255); font-size:11px;'>";
   	                          sb=sb+"	<a href='<?php echo base_url('consSerieGuia_c/mostrar_ver')?>"+"/"+fila['COD_SER_GUIA'].toString()+"'>";
      	  			    	  sb=sb+"	   Ver&nbsp";
